...
public class AdAstraRocketedRenderer {
    ...
    public static final ResourceLocation SATURN_V = new ResourceLocation(AdAstraRocketed.MOD_ID, "textures/block/saturn_v.png");
    public static final ResourceLocation SATURN_V_OBJ_FILE = new ResourceLocation(AdAstraRocketed.MOD_ID, "entity/saturn_v");
    public static final ModelResourceLocation SATURN_V_MRL = new ModelResourceLocation(SATURN_V_OBJ_FILE, "#");
}
